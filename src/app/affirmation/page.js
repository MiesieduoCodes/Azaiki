    ...
    <div className="bg-gray-900 text-gray-200">
      <div className="relative isolate px-6 pt-20 lg:px-8">
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <h1 className="letter-heading text-5xl font-semibold tracking-tight text-yellow-400">
            A Letter from the President
          </h1>

          {/* Content with animation */}
          <div className="letter-content mt-12">
            <p className="text-lg font-medium">Dear Members and Friends,</p>
            ...
            <p className="mt-4 text-lg">Thank you for your continued dedication and passion.</p>
