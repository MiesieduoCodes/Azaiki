    ...
    <div className="text-gray-900 dark:text-gray-100 min-h-screen bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      <motion.div className="relative bg-cover pt-24 bg-center bg-no-repeat text-white py-32 w-full shadow-lg" style={{ backgroundImage: `url(${coverImage})` }}>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 mx-auto flex flex-col items-center relative z-10">
          ...
          <motion.div className="mt-6 flex space-x-6">
            <a href={socialLinks.email}><FaEnvelope className="text-white text-3xl hover:text-gray-300 transition-colors" /></a>
            <a href={socialLinks.linkedin}><FaLinkedin className="text-white text-3xl hover:text-gray-300 transition-colors" /></a>
            <a href={socialLinks.twitter}><FaSquareXTwitter className="text-white text-3xl hover:text-gray-300 transition-colors" /></a>
          </motion.div>
        </div>
      </motion.div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <motion.section className="mb-12">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">{biography}</p>
        </motion.section>

        {/* Education Section */}
        <motion.section className="mb-12">
          <h2 className="text-3xl font-bold mb-6">Education</h2>
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">Professor Azaiki's academic journey reflects his commitment to lifelong learning and excellence.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {education.map((edu, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                ...
                {edu.institution && <p className="text-gray-600 dark:text-gray-300 mt-2">{edu.institution}</p>}
        ...
        <motion.section className="mb-12">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">A distinguished career spanning academia, public service, and governance.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {workExperience.map((exp, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="text-xl font-semibold">{exp.role}</h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">{exp.institution}</p>
                <p className="text-gray-500 dark:text-gray-400 mt-2">{exp.period}</p>
              </div>
            ))}
          </div>
        </motion.section>
        ...
        <motion.section className="mb-12">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">Key leadership roles in education and governance.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {appointments.map((app, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="text-xl font-semibold">{app.role}</h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">{app.institution}</p>
                <p className="text-gray-500 dark:text-gray-400 mt-2">{app.period}</p>
              </div>
            ))}
          </div>
        </motion.section>
        ...
        <motion.section className="mb-12">
          <h2 className="text-3xl font-bold mb-6">Community Service</h2>
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">Contributions to community development and nation-building.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {communityService.map((service, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="text-xl font-semibold">{service.activity}</h3>
                <p className="text-gray-500 dark:text-gray-400 mt-2">{service.year}</p>
              </div>
            ))}
          </div>
        </motion.section>
        ...
        <motion.section className="mb-12">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">Leadership in global and national organizations.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {activities.map((act, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="text-xl font-semibold">{act.role}</h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">{act.organization}</p>
                <p className="text-gray-500 dark:text-gray-400 mt-2">{act.period}</p>
              </div>
            ))}
          </div>
        </motion.section>
        ...
        {/* Politics Section */}
        <motion.section className="mb-12">
          <h2 className="text-3xl font-bold mb-6">Politics</h2>
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">Service in the Nigerian National Assembly.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {politics.map((pol, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="text-xl font-semibold">{pol.role}</h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">{pol.institution}</p>
                <p className="text-gray-500 dark:text-gray-400 mt-2">{pol.period}</p>
              </div>
            ))}
          </div>
        </motion.section>
        ...
        <motion.section className="mb-12">
          <h2 className="text-3xl font-bold mb-6">Director Positions</h2>
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">Board memberships in key organizations.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {directorPositions.map((dir, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="text-xl font-semibold">{dir.role}</h3>
                <p className="text-gray-600 dark:text-gray-300 mt-2">{dir.institution}</p>
              </div>
            ))}
          </div>
        </motion.section>
