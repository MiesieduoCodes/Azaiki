...
const galleryData = {
  ...
  artists: [
    {
      name: "Alice Johnson",
      bio: "A contemporary artist known for her vibrant use of color and abstract forms.",
      image: "https://images.pexels.com/photos/30693629/pexels-photo-30693629/free-photo-of-digital-art-creation-on-tablet-with-stylus.jpeg?auto=compress&cs=tinysrgb&w=600"
    },
    {
      name: "Mark Smith",
      bio: "An innovative sculptor whose works explore the intersection of technology and nature.",
      image: "https://images.pexels.com/photos/30693629/pexels-photo-30693629/free-photo-of-digital-art-creation-on-tablet-with-stylus.jpeg?auto=compress&cs=tinysrgb&w=600"
    },
  ]
};
          ...
          <div className="mx-auto w-auto relative">
            ...
            <div className="swiper-container gallery-top w-full md:w-[1028px] mx-auto xl:overflow-hidden pt-6">
              <div className="swiper-wrapper w-max mx-auto mb-5 flex gap-3">
                {galleryData.artworks.map((item, index) => (
        ...
        <div className="w-full max-w-7xl px-6 lg:px-8 mx-auto">
          <div className="flex items-center justify-center flex-col gap-5 mb-14">
            ...
            <p className="text-lg font-normal dark:text-white text-gray-800 max-w-3xl mx-auto text-center">
              Discover the talented artists behind the masterpieces. Each artist brings their unique vision and creativity to our gallery.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-14">
            {galleryData.artists.map((artist, index) => (
              <div key={index} className="block text-center">
                ...
                />
                <h3 className="text-xl font-bold dark:text-yellow-500 text-gray-900">{artist.name}</h3>
                <p className="text-gray-600 dark:text-gray-300">{artist.bio}</p>
              </div>
            ))}
          </div>
        </div>
