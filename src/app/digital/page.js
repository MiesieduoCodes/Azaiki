      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="pb-16">
          ...
          <p className="w-full text-center text-gray-600 dark:text-gray-300 text-lg font-normal leading-8">
            Immerse yourself in a world where creativity meets technology. Explore stunning digital masterpieces crafted by visionary artists.
          </p>
        </div>
          ...
          <div className="w-full max-w-7xl px-6 lg:px-8 mx-auto">
            <div className="flex items-center justify-center flex-col gap-5 mb-14">
              ...
              <p className="text-lg font-normal dark:text-white text-gray-800 max-w-3xl mx-auto text-center">
                Step into a curated collection of mesmerizing digital artworks. Each piece showcases the creativity, skill, and vision of talented artists from around the world.
              </p>
            </div>
    ...
    <div className="hero-content text-neutral-content text-center relative z-10">
      <div className="max-w-md">
        ...
        <p className="mb-5 text-light-text dark:text-dark-text">
          Join us to explore your creativity and showcase your digital art in a vibrant community.
        </p>
